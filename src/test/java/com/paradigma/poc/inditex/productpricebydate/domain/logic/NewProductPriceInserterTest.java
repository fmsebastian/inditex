...
public class NewProductPriceInserterTest {
    ...
    private static final LocalDateTime ORIGINAL_START_DATE = LocalDateTime.parse("2022-10-10T00:00:00");
    private static final LocalDateTime ORIGINAL_END_DATE = ORIGINAL_START_DATE.plus(PERIOD_PRODUCT_DATES);

    private static final ProductPriceBetweenDates ORIGINAL_PRODUCT_PRICE = ProductPriceBetweenDates.builder()
